  ...
  const stepsData = [
    {
      ...
      description: "Create your account in seconds using your mobile number. No complicated forms or verification delays.",
      image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02", 
      title: "Add Products & Upload Photos",
      description: "Take photos of your products, add prices and descriptions. Your store starts taking shape instantly.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Share & Start Selling",
      description: "Get your store link and QR code. Share on Facebook, TikTok, or display at your shop. Start receiving orders immediately!",
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">Start selling online in three easy steps</h2>
          <p className="section-subtitle mx-auto">
            From signup to your first sale — DukaanNepal makes it simple for everyone.
          </p>
        </div>
