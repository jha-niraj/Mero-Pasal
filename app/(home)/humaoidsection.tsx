        ...
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            ...
            <h2 className="section-title text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-1 md:mb-2">
              Why sellers choose DukaanNepal
            </h2>
            
            <p className="text-lg text-gray-600 mb-4">
              Three things local sellers love the most.
            </p>
          </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg">
                    No technical knowledge needed. Create your store, add products with photos, and start sharing your link instantly.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">Local Payments</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg">
                    Customers pay the way they prefer — digital wallets or cash on delivery. You get paid directly.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Share everywhere with <span className="text-pulse-400">QR codes</span>
                  </h3>
                  <p className="text-white/90 text-lg">
                    Get your unique store link and QR code. Share on Facebook, TikTok, WhatsApp, or print it at your shop.
                  </p>
                </div>
              </div>
            </div>
