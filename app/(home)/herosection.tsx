      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Take Your Shop Online in 5 Minutes<br className="hidden sm:inline" />— No Coding, No Hassle
            </h1>
            ...
            >
              Create your digital store, accept Esewa/Khalti payments, and start selling anywhere in Nepal.
            </p>
            ...
            >
              From grocery stores to clothing boutiques, every seller deserves an online presence. DukaanNepal helps you build your own online store — fast, simple, and 100% yours.
            </p>
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                <a 
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #ff6b3d 0%, #ff8756 100%)',
                    borderRadius: '1440px',
                    ...
                    padding: '16px 24px',
                    border: 'none',
                    boxShadow: '0 4px 15px rgba(255, 107, 61, 0.3)',
                  }}
                >
                  Create Your Store
              ...
              >
                Free during MVP • No hidden fees • Start selling in minutes
              </div>
              ...
              >
                <span>Built for Nepali sellers</span>
                <span>•</span>
                <span>Accept Esewa, Khalti & Cash on Delivery</span>
              </div>
            </div>
          </div>
            ...
            {lottieData ? (
              ...
              <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                <img 
                  ...
                  alt="DukaanNepal Store Dashboard" 
